...
export const ar = defineLocale({
  ...
  settings: {
    ...
    model: {
      ...
      delegationRoutes: {
        title: 'مسارات التفويض',
        description: 'مسارات نماذج معتمدة متاحة لـ delegate_task. تنطبق التغييرات على الجلسات الجديدة.',
        add: 'إضافة مسار',
        empty: 'لا توجد مسارات معتمدة. تستخدم الوكلاء الفرعية الإعداد الافتراضي.',
        change: 'تغيير',
        remove: 'إزالة',
        removeAria: alias => `إزالة ${alias}`,
        aliasLabel: 'اسم المسار',
        aliasPlaceholder: 'fast-review',
        selectModel: 'اختر نموذجًا',
        save: 'حفظ المسار',
        saveFailed: 'فشل حفظ مسارات التفويض',
        aliasError: 'استخدم من 1 إلى 64 حرفًا أو رقمًا أو شرطة أو شرطة سفلية، وابدأ بحرف أو رقم.',
        modelError: 'اختر مزودًا ونموذجًا.',
        duplicateError: 'اسم المسار هذا موجود بالفعل.'
      },
