...
export const zh: Translations = {
  ...
  settings: {
    ...
    model: {
      ...
      delegationRoutes: {
        title: '委派路由',
        description: '供 delegate_task 使用的已批准模型路由。更改会应用于新建会话。',
        add: '添加路由',
        empty: '尚无已批准路由。委派子代理将使用已配置的默认值。',
        change: '更改',
        remove: '移除',
        removeAria: alias => `移除 ${alias}`,
        aliasLabel: '路由别名',
        aliasPlaceholder: 'fast-review',
        selectModel: '选择模型',
        save: '保存路由',
        saveFailed: '保存委派路由失败',
        aliasError: '请使用 1–64 个字母、数字、连字符或下划线，并以字母或数字开头。',
        modelError: '请选择提供方和模型。',
        duplicateError: '该路由别名已存在。'
      },
      auxiliaryTitle: '辅助模型',
