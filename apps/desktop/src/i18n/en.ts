...
export const en: Translations = {
  ...
  settings: {
    ...
    model: {
      ...
      delegationRoutes: {
        title: 'Delegation routes',
        description: 'Approved model routes available to delegate_task. Changes apply to newly built sessions.',
        add: 'Add route',
        empty: 'No approved routes. Delegated children use the configured default.',
        change: 'Change',
        remove: 'Remove',
        removeAria: alias => `Remove ${alias}`,
        aliasLabel: 'Route alias',
        aliasPlaceholder: 'fast-review',
        selectModel: 'Select a model',
        save: 'Save route',
        saveFailed: 'Failed to save delegation routes',
        aliasError: 'Use 1–64 letters, numbers, hyphens, or underscores; start with a letter or number.',
        modelError: 'Choose a provider and model.',
        duplicateError: 'That route alias already exists.'
      },
