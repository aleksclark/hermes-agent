...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    model: {
      ...
      delegationRoutes: {
        title: '委派路由',
        description: '供 delegate_task 使用的核准模型路由。變更會套用至新建工作階段。',
        add: '新增路由',
        empty: '尚無核准路由。委派子代理會使用已設定的預設值。',
        change: '變更',
        remove: '移除',
        ...
        save: '儲存路由',
        saveFailed: '無法儲存委派路由',
        aliasError: '請使用 1–64 個字母、數字、連字號或底線，並以字母或數字開頭。',
        modelError: '請選擇提供方和模型。',
        duplicateError: '此路由別名已存在。'
      },
      auxiliaryTitle: '輔助模型',
